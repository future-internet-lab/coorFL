...
class MobileNetV2(nn.Module):
    def __init__(self, num_classes=10, width_mult=1.0):
        ...
        for t, c_out, n, s in self.cfgs:
            output_channel = c(c_out)
            for i in range(n):
        ...
        # final conv
        layers.append(nn.Conv2d(input_channel, last_channel, 1, 1, 0, bias=False))
